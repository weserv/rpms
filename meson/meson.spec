...
# Revert Python 3.6 deprecation notice
Patch0:         revert-09f03a8.patch
...
%changelog
* Sat Nov  8 2025 Kleis Auke Wolthuizen <info@kleisauke.nl> - 0.61.5-1
- Import from Fedora
- Update to 0.61.5
- Add patch to revert Python 3.6 deprecation notice
- Drop shell completions
